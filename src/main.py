"""
Kubernetes Self-Healing Agent - Main Controller
...
class SelfHealingController:
    """Main controller for the self-healing agent."""
    ...
    def __init__(self):
        ...
        self.excluded_namespaces = os.getenv(
            "EXCLUDED_NAMESPACES", 
            "kube-system,kube-public,self-healing"
        ).split(",")
        ...
        logger.info(f"Self-healing agent initialized (dry_run={self.dry_run})")
