...
```bash
git clone https://github.com/PrashantMurtale/k8s-self-healing-agent.git
...
### 3. Monitor logs
```bash
kubectl logs -f deployment/self-healing-agent -n self-healing
```
...
Need self-healing for your specific stack?
